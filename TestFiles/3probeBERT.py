...
print(nlpqa("¿Cual es su nombre?","Como hijo de Maria Mariana Montoya Mayo quien vive en el pueblo de Melchor Ocampo, mi nombre es Pedro Pablo Pérez Pereira,"))
