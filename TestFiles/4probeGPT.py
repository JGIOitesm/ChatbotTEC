...
conversation = Conversation([{"role": "user","content": "Yo soy don Francisco, hijo de Pepe quien recide en Ocampo. Yo soy de la familia Iglesias quien tambien vive allá."}])
